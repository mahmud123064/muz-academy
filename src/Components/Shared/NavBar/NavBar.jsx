...
import logo from "../../../../public/person.png"
const NavBar = () => {
    ...
    const menuItems = <>
        ...
        <li><NavLink className={({ isActive }) => isActive ? 'active' : 'default'} to={'/classes'}>Courses</NavLink></li>
        {
            ...
            <div className="navbar bg-base-100 MyContainer  ">
                <div className="navbar-start">
                    ...
                    <Link className='flex ml-3' to={'/'}>
                        ...
                        <div>
                            <p className="primary_text font-semibold normal-case text-xl">muzAcademy</p>
